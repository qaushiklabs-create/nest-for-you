...
?>
  ...
  <main class="main">
      ...
      <div class="container section-title" data-aos="fade-up">
          <h1><b><center>SECTORS</center></b></h1>
        <h2>Services</h2>
      ...
      <div class="container">
        ...
        <div class="row gy-4">
            ...
            <div class="service-item position-relative">
              ...
              <a href="sector45.php" class="stretched-link">
                <h3>Sector 45</h3>
              </a>
              <p>Navigate the property market with confidence, supported by our experienced team who are dedicated to helping you secure the perfect property.</p>
            </div>
        ...
        <div class="col-lg-4 col-md-6" data-aos="fade-up" data-aos-delay="200">
            <div class="service-item position-relative">
              ...
              <a href="sector46.php" class="stretched-link">
                <h3>Sector 46</h3>
              </a>
              <p>Navigate the property market with confidence, supported by our experienced team who are dedicated to helping you secure the perfect property.</p>
            </div>
          ...
          <div class="col-lg-4 col-md-6" data-aos="fade-up" data-aos-delay="100">
            <div class="service-item position-relative">
              ...
              <a href="sector51.php" class="stretched-link">
                <h3>Sector 51</h3>
              </a>
              <p>Let us guide you through the rental process with ease, providing expert advice and a curated list of properties to match your requirements.</p>
            </div>
          </div><!-- End Service Item -->
          ...
          <div class="col-lg-4 col-md-6" data-aos="fade-up" data-aos-delay="300">
            <div class="service-item position-relative">
              ...
              <a href="sector52.php" class="stretched-link">
                <h3>Sector 52</h3>
              </a>
              <p>Sell your property with confidence, backed by our comprehensive support and a proven track record of successful transactions.</p>
            </div>
          </div>
          ...
          <div class="col-lg-4 col-md-6" data-aos="fade-up" data-aos-delay="200">
            <div class="service-item position-relative">
              ...
              <a href="sector57.php" class="stretched-link">
                <h3>Sector 57</h3>
              </a>
              <p>Navigate the property market with confidence, supported by our experienced team who are dedicated to helping you secure the perfect property.</p>
            </div>
          ...
          <div class="col-lg-4 col-md-6" data-aos="fade-up" data-aos-delay="200">
            <div class="service-item position-relative">
              ...
              <a href="sector61.php" class="stretched-link">
                <h3>Sector 61</h3>
              </a>
              <p>Navigate the property market with confidence, supported by our experienced team who are dedicated to helping you secure the perfect property.</p>
            </div>
          ...
          <div class="col-lg-4 col-md-6" data-aos="fade-up" data-aos-delay="200">
            <div class="service-item position-relative">
              ...
              <a href="sector62.php" class="stretched-link">
                <h3>Sector 62</h3>
              </a>
              <p>Navigate the property market with confidence, supported by our experienced team who are dedicated to helping you secure the perfect property.</p>
            </div>
          ...
          <div class="col-lg-4 col-md-6" data-aos="fade-up" data-aos-delay="200">
            <div class="service-item position-relative">
              ...
              <a href="sector63.php" class="stretched-link">
                <h3>Sector 63</h3>
              </a>
              <p>Navigate the property market with confidence, supported by our experienced team who are dedicated to helping you secure the perfect property.</p>
            </div>

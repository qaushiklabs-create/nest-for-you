...
?>
  <!--<header id="header" class="header d-flex align-items-center fixed-top">
    <div class="container-fluid container-xl position-relative d-flex align-items-center justify-content-between">
      ...
      <a href="index.html" class="logo d-flex align-items-center me-auto me-lg-0">
         ...
         <img src="https://nestforyou.in/assets/img/logo.png" alt=""> 
        <h1 class="sitename">nestforyou</h1>
        <span>.</span>
      </a>
      ...
      <nav id="navmenu" class="navmenu">
        <ul>
          ...
          <li><a href="https://nestforyou.in/real-estate/rent/real-estate/rent.html">Rent</a></li>
          <li><a href="https://nestforyou.in/buy/buy.html">Buy</a></li>
          <li><a href="https://nestforyou.in/sell/sell.html">Sell</a></li>
          <li class="dropdown"><a href="#legaldocuments"><span>Legal Documentation</span> <i class="bi bi-chevron-down toggle-dropdown"></i></a>
            <ul>
              <li><a href="">Sale deed</a></li>
              <li><a href="">Gift deed</a></li>
              <li><a href="">Rent agreement</a></li>
              <li><a href="">Affidavit</a></li>
              <li><a href="">Power of attorney</a></li>
            </ul>
          </li>
          <li><a href="https://nestforyou.in/blogs.html">Blog</a></li>
  ...
  <main class="main">
      ...
      <div class="container" data-aos="fade-up" data-aos-delay="100">
        ...
        <div class="row gy-4">
          <div class="col-lg-12">
            <h3>Welcome to Property.in</h3><br>
            <p class="fst-italic">
              At Property.in, we are dedicated to transforming the way you experience real estate. With a commitment to excellence and a passion for finding the perfect property solutions, we are your trusted partner in navigating the dynamic world of real estate.
            </p>
          </div>
        </div>
        ...
        <div class="row gy-4">
          <div class="col-lg-4 col-md-6 footer-about">
            <a href="index.html" class="logo d-flex align-items-center">
              <span class="sitename">nestforyou</span>
            </a>
            <div class="footer-contact pt-3">
              <p>D11, Sun City</p>
              <p> Gurgaon, 122003</p>
              <p class="mt-3"><strong>Phone:</strong> <span>+91 9910780177</span></p>
              <p><strong>Email:</strong> <span>getnestforyou@gmail.com</span></p>
            </div>
          ...
          <div class="col-lg-2 col-md-3 footer-links">
            ...
            <ul>
              ...
              <li><i class="bi bi-chevron-right"></i> <a href="https://nestforyou.in/terms/terms.html"> Terms of service</a></li>
          ...
          <div class="col-lg-2 col-md-3 footer-links">
            <h4>Our Services</h4>
            <ul>
               <li><i class="bi bi-chevron-right"></i> <a href="https://nestforyou.in/real-estate/rent/real-estate/rent.html">Rent</a></li>
              <li><i class="bi bi-chevron-right"></i> <a href="https://nestforyou.in/buy/buy.html">Buy</a></li>
              <li><i class="bi bi-chevron-right"></i> <a href="https://nestforyou.in/sell/sell.html">Sell</a></li>
            </ul>
          </div>
        </div>
      </div>
